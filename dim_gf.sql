...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-05-2023 a las 13:19:20
...
CREATE TABLE `ranking` (
  `id_ranking` int(11) NOT NULL COMMENT 'PK',
  `nombre_jugador` varchar(10) NOT NULL,
  `puntos_jugador` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `ranking`
  MODIFY `id_ranking` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK';
